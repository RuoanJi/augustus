...
enum {
    ...
    FIGURE_ACTION_231_DEPOT_CART_PUSHER_INITIAL = 231,
    FIGURE_ACTION_232_DEPOT_CART_PUSHER_HEADING_TO_SOURCE = 232,
    FIGURE_ACTION_233_DEPOT_CART_PUSHER_AT_SOURCE = 233,
    FIGURE_ACTION_234_DEPOT_CART_HEADING_TO_DESTINATION = 234,
    FIGURE_ACTION_235_DEPOT_CART_PUSHER_AT_DESTINATION = 235,
    FIGURE_ACTION_236_DEPOT_CART_PUSHER_RETURNING = 236,
    FIGURE_ACTION_237_DEPOT_CART_PUSHER_CANCEL_ORDER = 237,
};
